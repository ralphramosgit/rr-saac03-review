    ...
    },
    {
      ...
      questions: [
        match('17-ls-m1', 'Match each.', [
          ...
          { left: 'Multi-step workflow w/ retries/branching', right: 'Step Functions' },
    ...
    },
    {
      ...
      questions: [
        match('17-ap-m1', 'Match each bad design to better choice.', [
          ...
          { left: 'Storing secrets in SSM Standard plaintext', right: 'Use Secrets Manager / SSM SecureString' }
        ])
      ]
    }
  ]
